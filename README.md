...
The Greenfield project begins on Week 6 Day 2 (Tuesday) and ends on Week 6 Day 5 (Friday). Your project must be feature __and__ code complete by the start of the day on Week 6 Day 5 (Friday).

You'll present you project to your cohort on Week 6 Day 5 (Friday) EOD. You'll use Friday to wrap up any lose ends and make sure your project is ready to for hand-off to the next team.
...
![](https://github.com/hackreactor/hrnyc9-greenfield/blob/master/JoesDiagram.png)
